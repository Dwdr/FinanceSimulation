...
class Permission
{
    ...
    #permisson for CRUD operation
    public const EH_EMPLOYEE_ALL = 'eh.employee.*';
    public const EH_EMPLOYEE_C = 'eh.employee.c';
    public const EH_EMPLOYEE_R = 'eh.employee.r';
    public const EH_EMPLOYEE_U = 'eh.employee.u';
    public const EH_EMPLOYEE_D = 'eh.employee.d';
}
