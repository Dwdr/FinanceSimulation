...
class CreateSysPermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection($this->connection)->create($tableNames['permissions'], function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
        ...
        Schema::connection($this->connection)->create($tableNames['roles'], function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->string('guard_name');
            $table->timestamps();
        ...
        Schema::connection($this->connection)->create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames) {
        ...
        Schema::connection($this->connection)->create($tableNames['model_has_roles'], function (Blueprint $table) use ($tableNames, $columnNames) {
        ...
        Schema::connection($this->connection)->create($tableNames['role_has_permissions'], function (Blueprint $table) use ($tableNames) {
            $table->unsignedInteger('permission_id');
            $table->unsignedInteger('role_id');
