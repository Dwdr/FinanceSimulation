...
@section('body_page_breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('ssc.profile.index') }}">{{__('ssc.profile.profile')}}</a></li>
            ...
            <form id="v_form" class="block form-horizontal form-label-left"
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="{{route('ssc.profile.index')}}" class="btn btn-secondary">{{__('auth.passwords.cancel')}}</a>
