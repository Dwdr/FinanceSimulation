...
{{-- Title --}}
@section('html_title', __('ssc/dashboard/index.title_html'))
@section('page_title', __('ssc/dashboard/index.title_page'))

@section('body_page_breadcrumb')
    <li class="breadcrumb-item active">{{ __('ssc/dashboard/index.breadcrumb_level_1') }}</li>
@endsection
