...
{{-- Title --}}
@section('html_title', __('ssc_faq_index.title_html'))
@section('page_title', __('ssc_faq_index.title_page'))

@section('body_page_breadcrumb')
    <li class="breadcrumb-item active">{{ __('ssc_faq_index.breadcrumb_level_1') }}</li>
    <li class="breadcrumb-item">{{ __('ssc_faq_index.breadcrumb_level_3') }}</li>
