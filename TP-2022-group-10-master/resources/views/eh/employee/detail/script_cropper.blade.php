        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="img-container">
                    <img id="preview_img" src="https://avatars0.githubusercontent.com/u/3456749" height="auto" width="100%">
                </div>
            </div>
            ...
            if (cropper) {
                ...
                canvas.toBlob(function (blob) {
                    ...
                    reader.onloadend = function() {
                        ...
                        $.ajax('{{route('eh.employee.cropper_image',!$mode['isModeEdit']?'create':$e->uuid)}}', {
                            method: 'POST',
                            data: formData,
                            processData: false,
                            contentType: false,
